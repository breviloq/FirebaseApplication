...
public class TaskListFirebaseActivity extends AppCompatActivity {
...
//                list = new ArrayList<>(); bug
        ...
        listView.setOnItemLongClickListener((parent, view, position, id) -> {
            ...
            Toast.makeText(TaskListFirebaseActivity.this, t.toString(), Toast.LENGTH_LONG).show();
            return true;
        });
        ...
        btn.setOnClickListener(v -> {
            ...
            Task t = new Task("Task-" + System.currentTimeMillis(),
                    rand.nextInt(2) == 0,
                    rand.nextInt(7) + 3);
//            t.setAuthorKey( Auth.authorizedUser.getKey() );
